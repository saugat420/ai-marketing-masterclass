    ...
    <section className="relative overflow-hidden">
      ...
      <div className="mx-auto flex w-full max-w-5xl items-start justify-center overflow-hidden px-4 pb-10 pt-9 text-center sm:min-h-[calc(100svh-77px)] sm:items-center sm:px-6 sm:py-14 lg:px-8 lg:py-16">
        <div className="w-full min-w-0 max-w-full">
          ...
          <h1 className="mx-auto max-w-4xl text-[2.05rem] font-extrabold leading-[1.02] tracking-normal text-white sm:text-5xl lg:text-6xl">
          ...
          <p className="mx-auto mt-4 max-w-[19.5rem] text-[0.95rem] leading-6 text-slate-300 sm:mt-6 sm:max-w-3xl sm:text-lg sm:leading-7">
          ...
          <div className="mt-6 flex flex-col items-center gap-2.5 sm:mt-8 sm:gap-3">
            ...
            <p className="text-sm font-bold text-yellow-100 [text-shadow:0_0_18px_rgba(250,204,21,0.65)]">

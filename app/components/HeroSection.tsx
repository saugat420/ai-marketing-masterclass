export function HeroSection() {
  return (
    <section className="relative overflow-hidden">
      <div className="absolute inset-0 -z-10 bg-[radial-gradient(circle_at_50%_0%,rgba(30,80,150,0.34),transparent_34%),radial-gradient(circle_at_18%_32%,rgba(250,204,21,0.12),transparent_22%),linear-gradient(180deg,#05070d_0%,#07111f_72%,#05070d_100%)]" />
      <div className="mx-auto flex w-full max-w-5xl items-start justify-center overflow-hidden px-4 pb-10 pt-9 text-center sm:min-h-[calc(100svh-77px)] sm:items-center sm:px-6 sm:py-14 lg:px-8 lg:py-16">
        <div className="w-full min-w-0 max-w-full">
          <div className="mb-4 inline-flex max-w-full rounded-full border border-yellow-500 bg-yellow-300 px-4 py-2 text-xs font-extrabold text-slate-950 shadow-[0_10px_28px_rgba(234,179,8,0.32)] sm:mb-6 sm:px-5 sm:py-2.5 sm:text-sm">
          ...
          <p className="mx-auto mt-4 max-w-[21rem] break-words text-base leading-7 text-slate-300 sm:mt-6 sm:max-w-3xl sm:text-lg sm:leading-7">

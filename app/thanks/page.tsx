  ...
  return (
    <main className="min-h-screen overflow-x-hidden bg-[#05070d] text-white">
      ...
      <section className="relative overflow-hidden px-4 py-12 sm:px-6 sm:py-16 lg:px-8">
        <div className="absolute inset-0 -z-10 bg-[radial-gradient(circle_at_top_left,rgba(30,80,150,0.34),transparent_34%),radial-gradient(circle_at_85%_15%,rgba(250,204,21,0.12),transparent_28%)]" />
      ...
      <section className="px-4 py-10 sm:px-6 lg:px-8">
        <div className="mx-auto max-w-4xl rounded-lg border border-white/10 bg-white/[0.06] p-7 text-center shadow-2xl shadow-black/25 sm:p-10">
